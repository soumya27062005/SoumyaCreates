...
const WORDS = ["Artificial Intelligence & Data Science Student", "Tech Enthusiast"];
const TECH_STACK = ["React", "Javascript", "Node.js", "Python"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/soumya27062005" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/soumya-harishbhai-gupta-0b113a308" },
  { icon: Instagram, link: "https://www.instagram.com/its_soumya_verse/" },
];
